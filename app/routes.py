...
def run_remove_backups():
    ...
    return render_template(
        "script_log_viewer.html", pagetitle="Script Logs", version=version
    )
...
def run_recreate_hdr():
    return render_template(
        "/recreate_hdr.html", pagetitle="Recreate HDR Posters", version=version
    )
...
def run_migrate():
    return render_template(
        "migrate.html", pagetitle="Config Migration", version=version
    )
...
def start_migrate():
    ...
    return render_template(
        "result.html", message=message, pagetitle="Config migrated", version=version
    )
...
def application_logs():
    return render_template(
        "application_log_viewer.html", pagetitle="Application Logs", version=version
    )
...
def config():
    if request.method == "GET":
        ...
        form.process()
        return render_template(
            "config.html", plex=plex, form=form, pagetitle="Config", version=version
        )
    if request.method == "POST":
        ...
        if form.validate_on_submit():
            ...
            return render_template(
                "config.html", plex=plex, form=form, pagetitle="Error", version=version
            )
    ...
    if request.method == "POST":
        ...
        if form.validate_on_submit():
            ...
            return render_template(
                "result.html",
                message=message,
                pagetitle="Config Options Updated",
                version=version,
            )
        else:
            Plex.id = id
